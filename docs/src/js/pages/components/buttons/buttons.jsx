...
var FlatButton = require('epui/lib/js/components/flat-button'),
    FloatingActionButton = require('epui/lib/js/components/floating-action-button'),
    FontIcon = require('epui/lib/js/components/font-icon'),
    RaisedButton = require('epui/lib/js/components/raised-button'),
    Tabs = require('epui/lib/js/components/tabs'),
    Tab = Tabs.Tab
    ;
